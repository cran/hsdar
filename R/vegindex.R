...
vegindex_available <- function()
{
  av <- c("NDVI","OSAVI","SAVI","MTVI","NDWI","PWI",
          ...
          "NDVI3","NPCI","OSAVI2","RDVI","REIP","REP_LE","REP_Li",
...
d_indexs <- c("Boochs","Boochs2","Datt3","D1","D2","EGFR","EGFN",
              "Vogelmann3","Sum_Dr1","Sum_Dr2","REP_LE")
...
if (index=="CI_Hanna")
{
  return(return_index(get_reflectance(y,x,760,weighted)/get_reflectance(y,x,695,weighted)))
}
if (index=="Vogelmann4")
{
