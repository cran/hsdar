...
DOUBLE PRECISION,INTENT(in) :: LIDFa,LIDFb,lai,q,rsoil(nw)
DOUBLE PRECISION,INTENT(in) :: tts,tto,psi
INTEGER(4),INTENT(in) :: TypeLIDF
!!!!!!!!    END INPUT / OUTPUT  !!!!!!!!

DOUBLE PRECISION :: chi_o,chi_s,ctl,sto,sts,tanto,tants,cospsi,koli,ksli,bf,bfli,alf,litab(13)
DOUBLE PRECISION :: f1,f2,g1(nw),g2(nw),ttl,sigf(nw),sobli,sofli,x1,x2,y1,y2,z
DOUBLE PRECISION :: fhot,fint,frho,ftau,J1ko(nw),J1ks(nw),J2ko(nw),J2ks(nw),Jfunc3
DOUBLE PRECISION :: T1(nw),T2(nw),T3(nw),Tv1(nw),Tv2(nw)
DOUBLE PRECISION :: e1(nw),e2(nw),rinf2(nw),re(nw),denom(nw)
DOUBLE PRECISION :: Ps(nw),Qs(nw),Pv(nw),Qv(nw),dn(nw)
INTEGER(4) :: na
...
!  
DOUBLE PRECISION,INTENT(in) :: k,l(nw),t
DOUBLE PRECISION,INTENT(out) :: Jout(nw)
DOUBLE PRECISION :: del(nw)
...
DOUBLE PRECISION :: k,l,t
DOUBLE PRECISION :: Jfunc3
