...
Formal class 'Speclib' [package "hsdar"] with 13 slots
  ..@ spectra            : num [1:81, 1:1401] 9.08 8.63 9.32 9.59 8.54 ...
...
> idSpeclib(newSpeclib) <- as.character(ids) #...and assign them to the new Speclib
\end{Sinput}
\end{Schunk}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-028}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-037}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-048}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-052}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-059}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-068}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-073}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-076}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-080}
}
\end{framed}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-085}
}
\end{framed}
...
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-099}
}
\end{framed}
...
> ## additionally mark the best performing model:
> mark_nri_best_performance(nribest, lmnri)
\end{Sinput}
\end{Schunk}
\resizebox{1\textwidth}{!}{
\includegraphics{hsdar-intro-109}
}
\end{framed}
Note that the reason why the rectangle seems to overlap with the neighbouring index is that channels 7 and 8 overlap in the Worldview-2-sensor.
