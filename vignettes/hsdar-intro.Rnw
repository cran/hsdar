...
plot(spectral_data, main = "Default Plot", ylim = c(0, 50))
plot(spectral_data, FUN = 1, main = "First spectrum of Speclib", ylim = c(0, 50))
plot(spectral_data, FUN = "median", main = "Median spectrum", ylim = c(0, 50))
plot(spectral_data, FUN = "mean", main = "Mean spectrum", ylim = c(0, 50))
@
}
\end{framed}
